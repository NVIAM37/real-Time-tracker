...
const Home = () => {
  ...
  const { getDisplayDistance, totalUsers, isLoading, error, hasConnections } = useUserDistances();
  ...
  return (
    ...
    >
      ...
      <div className="fixed top-2 left-2 bg-yellow-100 text-black p-2 rounded text-xs z-50">
        <p>Tab ID: {Date.now()}</p>
        ...
        <div className="w-full sm:w-[50%] py-10 items-center">
          ...
          {isLoading && (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500 mt-1">Checking for existing connections...</p>
              <p className="text-xs text-blue-500 mt-2">This may take a few seconds for new tabs</p>
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <div className="p-2 flex flex-col justify-evenly gap-1 ">
                    ...
                    <p className="text-xs text-blue-500 mt-1">
                      {totalUsers === 0 ? 'No users connected' : 
                       totalUsers === 1 ? 'Single user connected' : 
                ...
                >
                  ...
                  <div className="text-4xl font-bold">32 km/h</div>
                  <p className="text-[1.5rem] sm:text-[1rem] text-gray-400">
                    Velocity
                  </p>
                </div>
          ...
          {!isLoading && !error && totalUsers === 0 && (
            <div className="text-center py-8">
              <div className="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mx-auto max-w-md">
                ...
                <p className="text-xs text-blue-600 mt-1">Tip: Go to PathFinder first to establish a connection</p>
